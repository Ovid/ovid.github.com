map.load_stars = function() {
    ...
    this.stars[4] = new star( -0.98, -82.88, 6.86, "Barnard's Star  ", "M5", "3", "1", 1, 1 );
    ...
    this.stars[7] = new star( -22.54, 113.12, -34.58, "Sirius A", "A1", "4", "3", 1, 0 );
    this.stars[8] = new star( -22.54, 113.12, -34.58, "Sirius B", "DA2", "0", "0", 0, 0 );
    this.stars[9] = new star( 105.56, 48.72, -37.66, "L 726-8 A", "M5.5", "5", "2", 1, 0 );
    ...
    this.stars[33] = new star( 154.28, 50.26, -49.56, "L 725-32  ", "M5", "1", "4", 1, 0 );
    ...
    this.stars[56] = new star( 212.66, 5.74, -28.14, "G158-27  ", "M5.5", "2", "6", 1, 0 );
    ...
    this.stars[69] = new star( 100.94, 204.68, -30.66, "Omicron² Eridani A", "K1", "1", "10", 0, 0 );
    ...
    this.stars[73] = new star( 5.18, -231.98, 10.08, "70 Ophiuchi A", "K0", "2", "8", 1, 0 );
    this.stars[74] = new star( 5.18, -231.98, 10.08, "70 Ophiuchi B", "K5", "0", "0", 0, 0 );
    this.stars[75] = new star( 107.24, -205.66, 36.12, "Altair  ", "A7", "1", "9", 1, 0 );
    this.stars[76] = new star( -157.5, 160.16, 80.78, "G9-38 A", "M5.5", "1", "7", 1, 0 );
    ...
    this.wormholes[2] = { from: 0, to: 7, color: "0,0,235" };
    if (!this.stars[0].reachable) {
        this.wormholes[2].color = '0,255,255';
    }
    this.wormholes[3] = { from: 0, to: 9, color: "0,0,235" };
    if (!this.stars[0].reachable) {
        this.wormholes[3].color = '0,255,255';
    }
    this.wormholes[4] = { from: 0, to: 11, color: "0,0,235" };
    if (!this.stars[0].reachable) {
        this.wormholes[4].color = '0,255,255';
    }
    this.wormholes[5] = { from: 0, to: 12, color: "0,0,235" };
    if (!this.stars[0].reachable) {
        this.wormholes[5].color = '0,255,255';
    }
    this.wormholes[6] = { from: 0, to: 16, color: "0,0,235" };
    if (!this.stars[0].reachable) {
        this.wormholes[6].color = '0,255,255';
    }
    this.wormholes[7] = { from: 0, to: 19, color: "0,0,235" };
    if (!this.stars[0].reachable) {
        this.wormholes[7].color = '0,255,255';
    }
    this.wormholes[8] = { from: 1, to: 13, color: "0,0,235" };
    if (!this.stars[1].reachable) {
        this.wormholes[8].color = '0,255,255';
    }
    this.wormholes[9] = { from: 4, to: 23, color: "255,255,255" };
