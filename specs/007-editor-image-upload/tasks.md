...
- [x] T006 [US1] Create `t/Ovid/App/LiveEditor/upload.t` to cover success, overwrite rejection, MIME filtering, and config-sized failures for `POST /api/upload-image`.
