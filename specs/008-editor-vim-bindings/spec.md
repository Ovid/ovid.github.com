...
- What happens if `Ctrl-S` is pressed while a save is already in progress? (Should probably debounce or queue, but existing save logic handles this)
...
- **FR-002**: System MUST load the CodeMirror Vim keymap library.
